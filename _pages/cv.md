...
|----------|--------------|----------|---------------------|
| **Associate ML Scientist - 2** | Wadhwani Institute for Artificial Intelligence, Delhi | Jan 2025 - Sep 2025 | • Developed computer vision models for crop monitoring using Joint Positional Embedding models<br>• Applied MAE (Masked Autoencoder)-style pretraining strategies for region-specific pest recognition<br>• Evaluated and fine-tuned open-source Vision Language Models (VLMs) for agricultural applications<br>• Led pest monitoring projects with teams of ML analysts and interns |
...
|------|--------------|----------|-------------|
| **Project Lead** | Wadhwani Institute for Artificial Intelligence | 2023 - 2025 | Led teams of ML analysts and interns in agricultural AI projects |
